...
/-- Type quantifiers: k_ex373731# : Bool, level : Nat, k_ex373729# : Bool, k_ex373728# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex373776# : Bool, k_ex373775# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
  ≤ tlb_index ∧ tlb_index ≤ (64 - 1) -/
def translate_TLB_hit (sv_width : Nat) (asid : (BitVec (if ( 32 = 32  : Bool) then 9 else 16))) (vpn : (BitVec (sv_width - 12))) (ac : (AccessType Unit)) (priv : Privilege) (mxr : Bool) (do_sum : Bool) (ext_ptw : Unit) (tlb_index : Nat) (ent : TLB_Entry) : SailM (Result ((BitVec (if ( sv_width
...
/-- Type quantifiers: k_ex373797# : Bool, k_ex373796# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex373833# : Bool, k_ex373832# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
