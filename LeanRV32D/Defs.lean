...
instance : Inhabited (RegisterType reg) :=
  match reg with
  | .hart_state => by infer_instance
  | .mhpmcounter => by infer_instance
  | .mhpmevent => by infer_instance
  | .satp => by infer_instance
  | .tlb => by infer_instance
  | .pma_regions => by infer_instance
  | .htif_payload_writes => by infer_instance
  | .htif_cmd_write => by infer_instance
  | .htif_exit_code => by infer_instance
  | .htif_done => by infer_instance
  | .htif_tohost => by infer_instance
  | .stimecmp => by infer_instance
  | .mtimecmp => by infer_instance
  | .htif_tohost_base => by infer_instance
  | .pc_reset_address => by infer_instance
  | .elp => by infer_instance
  | .minstretcfg => by infer_instance
  | .mcyclecfg => by infer_instance
  | .vcsr => by infer_instance
  | .vr31 => by infer_instance
  | .vr30 => by infer_instance
  | .vr29 => by infer_instance
  | .vr28 => by infer_instance
  | .vr27 => by infer_instance
  | .vr26 => by infer_instance
  | .vr25 => by infer_instance
  | .vr24 => by infer_instance
  | .vr23 => by infer_instance
  | .vr22 => by infer_instance
  | .vr21 => by infer_instance
  | .vr20 => by infer_instance
  | .vr19 => by infer_instance
  | .vr18 => by infer_instance
  | .vr17 => by infer_instance
  | .vr16 => by infer_instance
  | .vr15 => by infer_instance
  | .vr14 => by infer_instance
  | .vr13 => by infer_instance
  | .vr12 => by infer_instance
  | .vr11 => by infer_instance
  | .vr10 => by infer_instance
  | .vr9 => by infer_instance
  | .vr8 => by infer_instance
  | .vr7 => by infer_instance
  | .vr6 => by infer_instance
  | .vr5 => by infer_instance
  | .vr4 => by infer_instance
  | .vr3 => by infer_instance
  | .vr2 => by infer_instance
  | .vr1 => by infer_instance
  | .vr0 => by infer_instance
  | .fcsr => by infer_instance
  | .f31 => by infer_instance
  | .f30 => by infer_instance
  | .f29 => by infer_instance
  | .f28 => by infer_instance
  | .f27 => by infer_instance
  | .f26 => by infer_instance
  | .f25 => by infer_instance
  | .f24 => by infer_instance
  | .f23 => by infer_instance
  | .f22 => by infer_instance
  | .f21 => by infer_instance
  | .f20 => by infer_instance
  | .f19 => by infer_instance
  | .f18 => by infer_instance
  | .f17 => by infer_instance
  | .f16 => by infer_instance
  | .f15 => by infer_instance
  | .f14 => by infer_instance
  | .f13 => by infer_instance
  | .f12 => by infer_instance
  | .f11 => by infer_instance
  | .f10 => by infer_instance
  | .f9 => by infer_instance
  | .f8 => by infer_instance
  | .f7 => by infer_instance
  | .f6 => by infer_instance
  | .f5 => by infer_instance
  | .f4 => by infer_instance
  | .f3 => by infer_instance
  | .f2 => by infer_instance
  | .f1 => by infer_instance
  | .f0 => by infer_instance
  | .pmpaddr_n => by infer_instance
  | .pmpcfg_n => by infer_instance
  | .tselect => by infer_instance
  | .stval => by infer_instance
  | .scause => by infer_instance
  | .sepc => by infer_instance
  | .sscratch => by infer_instance
  | .stvec => by infer_instance
  | .mconfigptr => by infer_instance
  | .mhartid => by infer_instance
  | .marchid => by infer_instance
  | .mimpid => by infer_instance
  | .mvendorid => by infer_instance
  | .minstret_increment => by infer_instance
  | .minstret => by infer_instance
  | .mtime => by infer_instance
  | .mcycle => by infer_instance
  | .mcountinhibit => by infer_instance
  | .mcounteren => by infer_instance
  | .scounteren => by infer_instance
  | .mscratch => by infer_instance
  | .mtval => by infer_instance
  | .mepc => by infer_instance
  | .mcause => by infer_instance
  | .mtvec => by infer_instance
  | .mideleg => by infer_instance
  | .medeleg => by infer_instance
  | .mip => by infer_instance
  | .mie => by infer_instance
  | .cur_inst => by infer_instance
  | .x31 => by infer_instance
  | .x30 => by infer_instance
  | .x29 => by infer_instance
  | .x28 => by infer_instance
  | .x27 => by infer_instance
  | .x26 => by infer_instance
  | .x25 => by infer_instance
  | .x24 => by infer_instance
  | .x23 => by infer_instance
  | .x22 => by infer_instance
  | .x21 => by infer_instance
  | .x20 => by infer_instance
  | .x19 => by infer_instance
  | .x18 => by infer_instance
  | .x17 => by infer_instance
  | .x16 => by infer_instance
  | .x15 => by infer_instance
  | .x14 => by infer_instance
  | .x13 => by infer_instance
  | .x12 => by infer_instance
  | .x11 => by infer_instance
  | .x10 => by infer_instance
  | .x9 => by infer_instance
  | .x8 => by infer_instance
  | .x7 => by infer_instance
  | .x6 => by infer_instance
  | .x5 => by infer_instance
  | .x4 => by infer_instance
  | .x3 => by infer_instance
  | .x2 => by infer_instance
  | .x1 => by infer_instance
  | .nextPC => by infer_instance
  | .PC => by infer_instance
  | .vstart => by infer_instance
  | .vl => by infer_instance
  | .vtype => by infer_instance
  | .menvcfg => by infer_instance
  | .mseccfg => by infer_instance
  | .senvcfg => by infer_instance
  | .mstatus => by infer_instance
  | .misa => by infer_instance
  | .cur_privilege => by infer_instance
  | .rvfi_mem_data_present => by infer_instance
  | .rvfi_mem_data => by infer_instance
  | .rvfi_int_data_present => by infer_instance
  | .rvfi_int_data => by infer_instance
  | .rvfi_pc_data => by infer_instance
  | .rvfi_inst_data => by infer_instance
  | .rvfi_instruction => by infer_instance
  | .fp_rounding_global => by infer_instance
