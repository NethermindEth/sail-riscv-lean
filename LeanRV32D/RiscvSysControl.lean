...
/-- Type quantifiers: k_ex371834# : Bool -/
...
/-- Type quantifiers: k_ex371870# : Bool -/
...
/-- Type quantifiers: k_ex372488# : Bool -/
...
def getPendingSet (priv : Privilege) : SailM (Option ((BitVec 32) × Privilege)) := do
  assert ((← (currentlyEnabled Ext_S)) || ((← readReg mideleg) == (zeros (n := 32)))) "riscv_sys_control.sail:70.58-70.59"
  let pending_m ← do
...
/-- Type quantifiers: k_ex372554# : Bool -/
