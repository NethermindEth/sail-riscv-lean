...
/-- Type quantifiers: k_ex373952# : Bool, k_ex373951# : Bool, k_ex373950# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex374003# : Bool, k_ex374002# : Bool, k_ex374001# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex374038# : Bool, k_ex374037# : Bool, k_ex374036# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
