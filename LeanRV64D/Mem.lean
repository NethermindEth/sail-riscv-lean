...
/-- Type quantifiers: k_ex524821_ : Bool, k_ex524820_ : Bool, k_ex524819_ : Bool -/
...
/-- Type quantifiers: k_ex524827_ : Bool, k_ex524826_ : Bool, k_ex524825_ : Bool -/
...
/-- Type quantifiers: k_ex524834_ : Bool, k_ex524833_ : Bool, k_ex524832_ : Bool, k_ex524831_ : Bool, width
...
def phys_mem_read (t : (MemoryAccessType Unit)) (paddr : physaddr) (width : Nat) (aq : Bool) (rl : Bool) (res : Bool) (meta' : Bool) : SailM (Result ((BitVec (8 * width)) × Unit) ExceptionType) := do
  ...
  | (.Load Data, none) => (pure (Err (E_Load_Access_Fault ())))
...
/-- Type quantifiers: k_ex524851_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex524971_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex524976_ : Bool, k_ex524975_ : Bool, k_ex524974_ : Bool, k_ex524973_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex524985_ : Bool, k_ex524984_ : Bool, k_ex524983_ : Bool, k_ex524982_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex525039_ : Bool, k_ex525038_ : Bool, k_ex525037_ : Bool, k_ex525036_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex525042_ : Bool, k_ex525041_ : Bool, k_ex525040_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex525045_ : Bool, k_ex525044_ : Bool, k_ex525043_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex525048_ : Bool, k_ex525047_ : Bool, k_ex525046_ : Bool, width : Nat, 0 <
...
/-- Type quantifiers: k_ex525063_ : Bool, k_ex525062_ : Bool, k_ex525061_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex525075_ : Bool, k_ex525074_ : Bool, k_ex525073_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex525087_ : Bool, k_ex525086_ : Bool, k_ex525085_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex525090_ : Bool, k_ex525089_ : Bool, k_ex525088_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex525093_ : Bool, k_ex525092_ : Bool, k_ex525091_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
