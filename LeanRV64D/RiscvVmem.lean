...
/-- Type quantifiers: k_ex375967# : Bool, level : Nat, k_ex375965# : Bool, k_ex375964# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex376012# : Bool, k_ex376011# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex376033# : Bool, k_ex376032# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex376069# : Bool, k_ex376068# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
