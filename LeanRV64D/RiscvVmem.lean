...
/-- Type quantifiers: k_ex376089# : Bool, level : Nat, k_ex376087# : Bool, k_ex376086# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex376134# : Bool, k_ex376133# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex376155# : Bool, k_ex376154# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex376191# : Bool, k_ex376190# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
