...
/-- Type quantifiers: k_ex375859# : Bool, level : Nat, k_ex375857# : Bool, k_ex375856# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375904# : Bool, k_ex375903# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375925# : Bool, k_ex375924# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375961# : Bool, k_ex375960# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
