...
/-- Type quantifiers: k_ex375881# : Bool, level : Nat, k_ex375879# : Bool, k_ex375878# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375926# : Bool, k_ex375925# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375947# : Bool, k_ex375946# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375983# : Bool, k_ex375982# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
