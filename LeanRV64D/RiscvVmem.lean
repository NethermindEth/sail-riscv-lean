...
/-- Type quantifiers: k_ex379003# : Bool, level : Nat, k_ex379001# : Bool, k_ex379000# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379048# : Bool, k_ex379047# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379069# : Bool, k_ex379068# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex379105# : Bool, k_ex379104# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
