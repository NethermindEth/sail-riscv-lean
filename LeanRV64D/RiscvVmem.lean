...
/-- Type quantifiers: k_ex374893# : Bool, level : Nat, k_ex374891# : Bool, k_ex374890# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex374938# : Bool, k_ex374937# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex374959# : Bool, k_ex374958# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex374995# : Bool, k_ex374994# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
