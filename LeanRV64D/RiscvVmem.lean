...
/-- Type quantifiers: k_ex377064# : Bool, level : Nat, k_ex377062# : Bool, k_ex377061# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex377109# : Bool, k_ex377108# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex377130# : Bool, k_ex377129# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex377166# : Bool, k_ex377165# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
