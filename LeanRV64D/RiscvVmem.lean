...
/-- Type quantifiers: k_ex376489# : Bool, level : Nat, k_ex376487# : Bool, k_ex376486# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex376534# : Bool, k_ex376533# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex376555# : Bool, k_ex376554# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex376591# : Bool, k_ex376590# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
