...
/-- Type quantifiers: k_ex374706# : Bool, level : Nat, k_ex374704# : Bool, k_ex374703# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex374751# : Bool, k_ex374750# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex374772# : Bool, k_ex374771# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex374808# : Bool, k_ex374807# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
