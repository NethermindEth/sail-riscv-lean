...
/-- Type quantifiers: k_ex373741# : Bool, level : Nat, k_ex373739# : Bool, k_ex373738# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex373786# : Bool, k_ex373785# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex373807# : Bool, k_ex373806# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex373843# : Bool, k_ex373842# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
