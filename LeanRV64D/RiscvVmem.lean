...
/-- Type quantifiers: k_ex379925# : Bool, level : Nat, k_ex379923# : Bool, k_ex379922# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379970# : Bool, k_ex379969# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379991# : Bool, k_ex379990# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex380027# : Bool, k_ex380026# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
