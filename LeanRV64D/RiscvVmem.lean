...
/-- Type quantifiers: k_ex374940# : Bool, level : Nat, k_ex374938# : Bool, k_ex374937# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex374985# : Bool, k_ex374984# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375006# : Bool, k_ex375005# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375042# : Bool, k_ex375041# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
