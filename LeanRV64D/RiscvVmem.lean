...
/-- Type quantifiers: k_ex377239# : Bool, level : Nat, k_ex377237# : Bool, k_ex377236# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex377284# : Bool, k_ex377283# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex377305# : Bool, k_ex377304# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex377341# : Bool, k_ex377340# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
