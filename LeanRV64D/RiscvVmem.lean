...
/-- Type quantifiers: k_ex375837# : Bool, level : Nat, k_ex375835# : Bool, k_ex375834# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375882# : Bool, k_ex375881# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375903# : Bool, k_ex375902# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375939# : Bool, k_ex375938# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
