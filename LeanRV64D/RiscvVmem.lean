...
/-- Type quantifiers: k_ex378023# : Bool, level : Nat, k_ex378021# : Bool, k_ex378020# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex378068# : Bool, k_ex378067# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex378089# : Bool, k_ex378088# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex378125# : Bool, k_ex378124# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
