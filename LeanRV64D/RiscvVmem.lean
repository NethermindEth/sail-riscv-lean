...
/-- Type quantifiers: k_ex373452# : Bool, level : Nat, k_ex373450# : Bool, k_ex373449# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex373497# : Bool, k_ex373496# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex373518# : Bool, k_ex373517# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex373554# : Bool, k_ex373553# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
