...
/-- Type quantifiers: k_ex379237# : Bool, level : Nat, k_ex379235# : Bool, k_ex379234# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379282# : Bool, k_ex379281# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379303# : Bool, k_ex379302# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex379339# : Bool, k_ex379338# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
