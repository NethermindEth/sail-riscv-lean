...
/-- Type quantifiers: k_ex378895# : Bool, level : Nat, k_ex378893# : Bool, k_ex378892# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex378940# : Bool, k_ex378939# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex378961# : Bool, k_ex378960# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex378997# : Bool, k_ex378996# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
