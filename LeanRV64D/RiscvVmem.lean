...
/-- Type quantifiers: k_ex377232# : Bool, level : Nat, k_ex377230# : Bool, k_ex377229# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex377277# : Bool, k_ex377276# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex377298# : Bool, k_ex377297# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex377334# : Bool, k_ex377333# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
