...
/-- Type quantifiers: k_ex377889# : Bool, level : Nat, k_ex377887# : Bool, k_ex377886# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex377934# : Bool, k_ex377933# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex377955# : Bool, k_ex377954# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex377991# : Bool, k_ex377990# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
