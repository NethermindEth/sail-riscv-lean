...
/-- Type quantifiers: k_ex380126# : Bool, level : Nat, k_ex380124# : Bool, k_ex380123# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex380171# : Bool, k_ex380170# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex380192# : Bool, k_ex380191# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex380228# : Bool, k_ex380227# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
