...
/-- Type quantifiers: k_ex375825# : Bool, level : Nat, k_ex375823# : Bool, k_ex375822# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375870# : Bool, k_ex375869# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375891# : Bool, k_ex375890# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375927# : Bool, k_ex375926# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
