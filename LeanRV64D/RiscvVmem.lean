...
/-- Type quantifiers: k_ex377326# : Bool, level : Nat, k_ex377324# : Bool, k_ex377323# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex377371# : Bool, k_ex377370# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex377392# : Bool, k_ex377391# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex377428# : Bool, k_ex377427# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
