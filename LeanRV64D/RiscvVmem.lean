...
/-- Type quantifiers: k_ex376481# : Bool, level : Nat, k_ex376479# : Bool, k_ex376478# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex376526# : Bool, k_ex376525# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex376547# : Bool, k_ex376546# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex376583# : Bool, k_ex376582# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
