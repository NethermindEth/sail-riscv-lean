...
/-- Type quantifiers: k_ex374022# : Bool, level : Nat, k_ex374020# : Bool, k_ex374019# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex374067# : Bool, k_ex374066# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex374088# : Bool, k_ex374087# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex374124# : Bool, k_ex374123# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
