...
/-- Type quantifiers: k_ex375784# : Bool, level : Nat, k_ex375782# : Bool, k_ex375781# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375829# : Bool, k_ex375828# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375850# : Bool, k_ex375849# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375886# : Bool, k_ex375885# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
