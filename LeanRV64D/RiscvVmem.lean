...
/-- Type quantifiers: k_ex379968# : Bool, level : Nat, k_ex379966# : Bool, k_ex379965# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex380013# : Bool, k_ex380012# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex380034# : Bool, k_ex380033# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex380070# : Bool, k_ex380069# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
