...
/-- Type quantifiers: k_ex375565# : Bool, level : Nat, k_ex375563# : Bool, k_ex375562# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375610# : Bool, k_ex375609# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375631# : Bool, k_ex375630# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375667# : Bool, k_ex375666# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
