...
/-- Type quantifiers: k_ex378797# : Bool, level : Nat, k_ex378795# : Bool, k_ex378794# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex378842# : Bool, k_ex378841# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex378863# : Bool, k_ex378862# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex378899# : Bool, k_ex378898# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
