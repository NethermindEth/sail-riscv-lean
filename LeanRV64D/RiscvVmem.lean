...
/-- Type quantifiers: k_ex377094# : Bool, level : Nat, k_ex377092# : Bool, k_ex377091# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex377139# : Bool, k_ex377138# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex377160# : Bool, k_ex377159# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex377196# : Bool, k_ex377195# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
