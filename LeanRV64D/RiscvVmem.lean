...
/-- Type quantifiers: k_ex375579# : Bool, level : Nat, k_ex375577# : Bool, k_ex375576# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375624# : Bool, k_ex375623# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375645# : Bool, k_ex375644# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375681# : Bool, k_ex375680# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
