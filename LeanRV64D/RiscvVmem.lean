...
/-- Type quantifiers: k_ex378264# : Bool, level : Nat, k_ex378262# : Bool, k_ex378261# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex378309# : Bool, k_ex378308# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex378330# : Bool, k_ex378329# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex378366# : Bool, k_ex378365# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
