...
/-- Type quantifiers: k_ex378883# : Bool, level : Nat, k_ex378881# : Bool, k_ex378880# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex378928# : Bool, k_ex378927# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex378949# : Bool, k_ex378948# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex378985# : Bool, k_ex378984# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
