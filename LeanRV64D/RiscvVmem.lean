...
/-- Type quantifiers: k_ex379316# : Bool, level : Nat, k_ex379314# : Bool, k_ex379313# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379361# : Bool, k_ex379360# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379382# : Bool, k_ex379381# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex379418# : Bool, k_ex379417# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
