...
/-- Type quantifiers: k_ex375763# : Bool, level : Nat, k_ex375761# : Bool, k_ex375760# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375808# : Bool, k_ex375807# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375829# : Bool, k_ex375828# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375865# : Bool, k_ex375864# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
