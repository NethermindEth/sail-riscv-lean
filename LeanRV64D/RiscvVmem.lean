...
/-- Type quantifiers: k_ex380667# : Bool, level : Nat, k_ex380665# : Bool, k_ex380664# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex380712# : Bool, k_ex380711# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex380733# : Bool, k_ex380732# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex380769# : Bool, k_ex380768# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
