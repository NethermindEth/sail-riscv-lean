...
/-- Type quantifiers: k_ex379315# : Bool, level : Nat, k_ex379313# : Bool, k_ex379312# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379360# : Bool, k_ex379359# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379381# : Bool, k_ex379380# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex379417# : Bool, k_ex379416# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
