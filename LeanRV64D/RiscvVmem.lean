...
/-- Type quantifiers: k_ex375361# : Bool, level : Nat, k_ex375359# : Bool, k_ex375358# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375406# : Bool, k_ex375405# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375427# : Bool, k_ex375426# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375463# : Bool, k_ex375462# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
