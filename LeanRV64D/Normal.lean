...
/-- Type quantifiers: k_ex516764_ : Nat, k_ex516764_ ∈ {16, 32, 64, 128} -/
def float_is_normal (op : (BitVec k_ex516764_)) : Bool :=
...
def float_is_subnormal (op : (BitVec k_ex516782_)) : Bool :=
