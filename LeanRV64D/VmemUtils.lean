...
/-- Type quantifiers: k_ex388370# : Bool, k_ex388369# : Bool, k_ex388368# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex388405# : Bool, k_ex388404# : Bool, k_ex388403# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex388451# : Bool, k_ex388450# : Bool, k_ex388449# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex388461# : Bool, k_ex388460# : Bool, k_ex388459# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
