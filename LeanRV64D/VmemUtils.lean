...
/-- Type quantifiers: k_ex398242# : Bool, k_ex398241# : Bool, k_ex398240# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex398277# : Bool, k_ex398276# : Bool, k_ex398275# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex398323# : Bool, k_ex398322# : Bool, k_ex398321# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex398333# : Bool, k_ex398332# : Bool, k_ex398331# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
