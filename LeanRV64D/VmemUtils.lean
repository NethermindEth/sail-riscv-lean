...
/-- Type quantifiers: k_ex379966# : Bool, k_ex379965# : Bool, k_ex379964# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex380001# : Bool, k_ex380000# : Bool, k_ex379999# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
