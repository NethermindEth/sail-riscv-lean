...
/-- Type quantifiers: k_ex657271_ : Bool, k_ex657270_ : Bool, k_ex657269_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex657306_ : Bool, k_ex657305_ : Bool, k_ex657304_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex657352_ : Bool, k_ex657351_ : Bool, k_ex657350_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex657362_ : Bool, k_ex657361_ : Bool, k_ex657360_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
