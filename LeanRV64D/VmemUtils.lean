...
/-- Type quantifiers: k_ex641766_ : Bool, k_ex641765_ : Bool, k_ex641764_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex641801_ : Bool, k_ex641800_ : Bool, k_ex641799_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex641847_ : Bool, k_ex641846_ : Bool, k_ex641845_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex641857_ : Bool, k_ex641856_ : Bool, k_ex641855_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
