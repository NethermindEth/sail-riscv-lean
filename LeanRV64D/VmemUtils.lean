...
/-- Type quantifiers: k_ex641691_ : Bool, k_ex641690_ : Bool, k_ex641689_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex641726_ : Bool, k_ex641725_ : Bool, k_ex641724_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex641772_ : Bool, k_ex641771_ : Bool, k_ex641770_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex641782_ : Bool, k_ex641781_ : Bool, k_ex641780_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
