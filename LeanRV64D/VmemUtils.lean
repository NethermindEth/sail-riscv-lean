...
/-- Type quantifiers: k_ex656903_ : Bool, k_ex656902_ : Bool, k_ex656901_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex656938_ : Bool, k_ex656937_ : Bool, k_ex656936_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex656984_ : Bool, k_ex656983_ : Bool, k_ex656982_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex656994_ : Bool, k_ex656993_ : Bool, k_ex656992_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
