...
/-- Type quantifiers: k_ex376005# : Bool, k_ex376004# : Bool, k_ex376003# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex376055# : Bool, k_ex376054# : Bool, k_ex376053# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex376090# : Bool, k_ex376089# : Bool, k_ex376088# : Bool, width : Nat, is_mem_width(width) -/
