...
/-- Type quantifiers: k_ex377547# : Bool, k_ex377546# : Bool, k_ex377545# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex377633# : Bool, k_ex377632# : Bool, k_ex377631# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
