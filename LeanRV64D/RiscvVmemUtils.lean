...
/-- Type quantifiers: k_ex376188# : Bool, k_ex376187# : Bool, k_ex376186# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex376273# : Bool, k_ex376272# : Bool, k_ex376271# : Bool, width : Nat, is_mem_width(width) -/
