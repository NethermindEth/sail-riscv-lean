...
/-- Type quantifiers: k_ex379537# : Bool, k_ex379536# : Bool, k_ex379535# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex379588# : Bool, k_ex379587# : Bool, k_ex379586# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex379623# : Bool, k_ex379622# : Bool, k_ex379621# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
