...
/-- Type quantifiers: k_ex379018# : Bool, k_ex379017# : Bool, k_ex379016# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex379069# : Bool, k_ex379068# : Bool, k_ex379067# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
