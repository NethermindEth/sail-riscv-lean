...
/-- Type quantifiers: k_ex377873# : Bool, k_ex377872# : Bool, k_ex377871# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex377908# : Bool, k_ex377907# : Bool, k_ex377906# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
