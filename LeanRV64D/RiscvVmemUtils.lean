...
/-- Type quantifiers: k_ex377039# : Bool, k_ex377038# : Bool, k_ex377037# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex377090# : Bool, k_ex377089# : Bool, k_ex377088# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex377125# : Bool, k_ex377124# : Bool, k_ex377123# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
