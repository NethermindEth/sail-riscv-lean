...
/-- Type quantifiers: k_ex377453# : Bool, k_ex377452# : Bool, k_ex377451# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex377504# : Bool, k_ex377503# : Bool, k_ex377502# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
