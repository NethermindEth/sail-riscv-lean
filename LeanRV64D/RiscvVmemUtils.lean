...
/-- Type quantifiers: k_ex374243# : Bool, k_ex374242# : Bool, k_ex374241# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex374293# : Bool, k_ex374292# : Bool, k_ex374291# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex374328# : Bool, k_ex374327# : Bool, k_ex374326# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
