...
/-- Type quantifiers: k_ex377038# : Bool, k_ex377037# : Bool, k_ex377036# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex377089# : Bool, k_ex377088# : Bool, k_ex377087# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex377124# : Bool, k_ex377123# : Bool, k_ex377122# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
