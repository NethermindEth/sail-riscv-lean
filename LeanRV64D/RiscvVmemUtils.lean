...
/-- Type quantifiers: k_ex378536# : Bool, k_ex378535# : Bool, k_ex378534# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex378571# : Bool, k_ex378570# : Bool, k_ex378569# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
