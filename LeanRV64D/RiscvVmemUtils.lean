...
/-- Type quantifiers: k_ex378538# : Bool, k_ex378537# : Bool, k_ex378536# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex378573# : Bool, k_ex378572# : Bool, k_ex378571# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
