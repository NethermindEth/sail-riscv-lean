...
/-- Type quantifiers: k_ex377138# : Bool, k_ex377137# : Bool, k_ex377136# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex377173# : Bool, k_ex377172# : Bool, k_ex377171# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
