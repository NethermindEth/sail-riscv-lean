...
/-- Type quantifiers: k_ex375582# : Bool, k_ex375581# : Bool, k_ex375580# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex375633# : Bool, k_ex375632# : Bool, k_ex375631# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex375668# : Bool, k_ex375667# : Bool, k_ex375666# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
