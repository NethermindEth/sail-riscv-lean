...
/-- Type quantifiers: k_ex378161# : Bool, k_ex378160# : Bool, k_ex378159# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex378196# : Bool, k_ex378195# : Bool, k_ex378194# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
