...
/-- Type quantifiers: k_ex377177# : Bool, k_ex377176# : Bool, k_ex377175# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex377228# : Bool, k_ex377227# : Bool, k_ex377226# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex377263# : Bool, k_ex377262# : Bool, k_ex377261# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
