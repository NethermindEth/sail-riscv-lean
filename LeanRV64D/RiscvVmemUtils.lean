...
/-- Type quantifiers: k_ex375212# : Bool, k_ex375211# : Bool, k_ex375210# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex375247# : Bool, k_ex375246# : Bool, k_ex375245# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
