...
/-- Type quantifiers: k_ex379111# : Bool, k_ex379110# : Bool, k_ex379109# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex379162# : Bool, k_ex379161# : Bool, k_ex379160# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex379197# : Bool, k_ex379196# : Bool, k_ex379195# : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
