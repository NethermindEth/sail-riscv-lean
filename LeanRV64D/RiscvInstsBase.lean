...
/-- Type quantifiers: k_ex375939# : Bool, width : Nat, width ∈ {1, 2, 4, 8} -/
def valid_load_encdec (width : Nat) (is_unsigned : Bool) : Bool :=
  ((width <b xlen_bytes) || ((not is_unsigned) && (width ≤b xlen_bytes)))

/-- Type quantifiers: k_ex375942# : Bool, k_n : Nat, k_n ≥ 0, 0 < k_n ∧ k_n ≤ xlen -/
...
/-- Type quantifiers: k_ex375943# : Bool -/
...
/-- Type quantifiers: k_ex375944# : Bool -/
