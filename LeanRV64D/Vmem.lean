...
/-- Type quantifiers: k_ex395149# : Bool, level : Nat, k_ex395147# : Bool, k_ex395146# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex395194# : Bool, k_ex395193# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex395215# : Bool, k_ex395214# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex395251# : Bool, k_ex395250# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
