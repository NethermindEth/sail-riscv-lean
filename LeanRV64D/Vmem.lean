...
/-- Type quantifiers: k_ex379694# : Bool, level : Nat, k_ex379692# : Bool, k_ex379691# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379739# : Bool, k_ex379738# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379760# : Bool, k_ex379759# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex379796# : Bool, k_ex379795# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
