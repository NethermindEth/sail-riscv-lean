...
/-- Type quantifiers: k_ex397186# : Bool, level : Nat, k_ex397184# : Bool, k_ex397183# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex397231# : Bool, k_ex397230# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex397252# : Bool, k_ex397251# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex397288# : Bool, k_ex397287# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
