...
/-- Type quantifiers: k_ex402008# : Bool, level : Nat, k_ex402006# : Bool, k_ex402005# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex402053# : Bool, k_ex402052# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex402074# : Bool, k_ex402073# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex402110# : Bool, k_ex402109# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
