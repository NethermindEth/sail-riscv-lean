...
/-- Type quantifiers: k_ex378503# : Bool, level : Nat, k_ex378501# : Bool, k_ex378500# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex378548# : Bool, k_ex378547# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex378569# : Bool, k_ex378568# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex378605# : Bool, k_ex378604# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
