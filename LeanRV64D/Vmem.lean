...
/-- Type quantifiers: k_ex379554# : Bool, level : Nat, k_ex379552# : Bool, k_ex379551# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379599# : Bool, k_ex379598# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379620# : Bool, k_ex379619# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex379656# : Bool, k_ex379655# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
