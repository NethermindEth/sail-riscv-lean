...
/-- Type quantifiers: k_ex397164# : Bool, level : Nat, k_ex397162# : Bool, k_ex397161# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex397209# : Bool, k_ex397208# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex397230# : Bool, k_ex397229# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex397266# : Bool, k_ex397265# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
