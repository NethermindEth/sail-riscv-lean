...
/-- Type quantifiers: k_ex541930_ : Bool, level : Nat, k_ex541928_ : Bool, k_ex541927_ : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex541975_ : Bool, k_ex541974_ : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex541996_ : Bool, k_ex541995_ : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex542032_ : Bool, k_ex542031_ : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
