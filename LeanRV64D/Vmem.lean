...
/-- Type quantifiers: k_ex378475# : Bool, level : Nat, k_ex378473# : Bool, k_ex378472# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex378520# : Bool, k_ex378519# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex378541# : Bool, k_ex378540# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex378577# : Bool, k_ex378576# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
