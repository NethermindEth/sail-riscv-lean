...
/-- Type quantifiers: k_ex379744# : Bool, level : Nat, k_ex379742# : Bool, k_ex379741# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379789# : Bool, k_ex379788# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379810# : Bool, k_ex379809# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex379846# : Bool, k_ex379845# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
