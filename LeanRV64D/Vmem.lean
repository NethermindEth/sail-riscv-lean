...
/-- Type quantifiers: k_ex388143# : Bool, level : Nat, k_ex388141# : Bool, k_ex388140# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex388188# : Bool, k_ex388187# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex388209# : Bool, k_ex388208# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex388245# : Bool, k_ex388244# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
