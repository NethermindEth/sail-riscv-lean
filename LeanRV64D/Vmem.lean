...
/-- Type quantifiers: k_ex378629# : Bool, level : Nat, k_ex378627# : Bool, k_ex378626# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex378674# : Bool, k_ex378673# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex378695# : Bool, k_ex378694# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex378731# : Bool, k_ex378730# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
