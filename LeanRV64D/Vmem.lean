...
/-- Type quantifiers: k_ex398015# : Bool, level : Nat, k_ex398013# : Bool, k_ex398012# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex398060# : Bool, k_ex398059# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex398081# : Bool, k_ex398080# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex398117# : Bool, k_ex398116# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
