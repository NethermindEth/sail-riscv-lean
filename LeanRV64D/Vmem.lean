...
/-- Type quantifiers: k_ex542785# : Bool, level : Nat, k_ex542783# : Bool, k_ex542782# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex542830# : Bool, k_ex542829# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex542851# : Bool, k_ex542850# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex542887# : Bool, k_ex542886# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
