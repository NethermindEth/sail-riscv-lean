...
/-- Type quantifiers: k_ex397696# : Bool, level : Nat, k_ex397694# : Bool, k_ex397693# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex397741# : Bool, k_ex397740# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex397762# : Bool, k_ex397761# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex397798# : Bool, k_ex397797# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
