...
/-- Type quantifiers: k_ex392535# : Bool, level : Nat, k_ex392533# : Bool, k_ex392532# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex392580# : Bool, k_ex392579# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex392601# : Bool, k_ex392600# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex392637# : Bool, k_ex392636# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
