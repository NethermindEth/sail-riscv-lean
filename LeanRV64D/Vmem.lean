...
/-- Type quantifiers: k_ex379641# : Bool, level : Nat, k_ex379639# : Bool, k_ex379638# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex379686# : Bool, k_ex379685# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex379707# : Bool, k_ex379706# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex379743# : Bool, k_ex379742# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
