...
/-- Type quantifiers: k_ex525888_ : Bool, level : Nat, k_ex525886_ : Bool, k_ex525885_ : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex525933_ : Bool, k_ex525932_ : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
  ≤ tlb_index ∧ tlb_index ≤ (64 - 1) -/
def translate_TLB_hit (sv_width : Nat) (asid : (BitVec (if ( 64 = 32  : Bool) then 9 else 16))) (vpn : (BitVec (sv_width - 12))) (ac : (MemoryAccessType Unit)) (priv : Privilege) (mxr : Bool) (do_sum : Bool) (ext_ptw : Unit) (tlb_index : Nat) (ent : TLB_Entry) : SailM (Result ((BitVec (if ( sv_width
...
/-- Type quantifiers: k_ex525954_ : Bool, k_ex525953_ : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex525990_ : Bool, k_ex525989_ : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
