...
/-- Type quantifiers: k_ex542793# : Bool, level : Nat, k_ex542791# : Bool, k_ex542790# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex542838# : Bool, k_ex542837# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex542859# : Bool, k_ex542858# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex542895# : Bool, k_ex542894# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
