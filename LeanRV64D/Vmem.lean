...
/-- Type quantifiers: k_ex385464# : Bool, level : Nat, k_ex385462# : Bool, k_ex385461# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex385509# : Bool, k_ex385508# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex385530# : Bool, k_ex385529# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex385566# : Bool, k_ex385565# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
