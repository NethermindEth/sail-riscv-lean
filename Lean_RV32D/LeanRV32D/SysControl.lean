...
/-- Type quantifiers: k_ex374343# : Bool -/
...
/-- Type quantifiers: k_ex374379# : Bool -/
...
/-- Type quantifiers: k_ex374997# : Bool -/
...
def getPendingSet (priv : Privilege) : SailM (Option ((BitVec 32) × Privilege)) := do
  assert ((← (currentlyEnabled Ext_S)) || ((← readReg mideleg) == (zeros (n := 32)))) "sys/sys_control.sail:70.58-70.59"
  let pending_m ← do
...
/-- Type quantifiers: k_ex375063# : Bool -/
